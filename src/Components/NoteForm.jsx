...
function NoteForm () {
    ...
    return (
      <div className="bg-white rouded-lg shadow-md p-6 mb-8 mt-5">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="w-full bg-indigo-600 text-white py-2 rounded-md hover:bg-indigo-700 transition-colorsfocus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed" disabled={loading}>{loading ? "Creating..." : "Create Note"}</button>
        </form>
      </div>
    );
}
